<?php
    ...
    $config['photo']['photo_static'][$nametype]['height'] = 110;
    $config['photo']['photo_static'][$nametype]['thumb'] = '130x110x1';
...
*/
    ...
    $config['photo']['man_photo'][$nametype]['height_photo'] = 650;
    $config['photo']['man_photo'][$nametype]['thumb_photo'] = '1366x650x1';
    $config['photo']['man_photo'][$nametype]['img_type_photo'] = '.jpg|.gif|.png|.jpeg|.gif|.JPG|.PNG|.JPEG|.Png|.GIF';
    $config['photo']['man_photo'][$nametype]['upvideo'] = true;
    $config['photo']['man_photo'][$nametype]['video_photo'] = true;
    $config['photo']['man_photo'][$nametype]['img_type_video'] = '.mp3|.mp4';

    $nametype = "slide-gioi-thieu";
    ...
    $nametype = "slide-dich-vu";
    $config['photo']['man_photo'][$nametype]['title_main_photo'] = "Slideshow dịch vụ";
    $config['photo']['man_photo'][$nametype]['number_photo'] = 1;
    $config['photo']['man_photo'][$nametype]['images_photo'] = true;
    $config['photo']['man_photo'][$nametype]['avatar_photo'] = true;
    $config['photo']['man_photo'][$nametype]['link_photo'] = true;
    ...
    $nametype = "slide-tin-tuc";
    $config['photo']['man_photo'][$nametype]['title_main_photo'] = "Slideshow tin tức";
    $config['photo']['man_photo'][$nametype]['number_photo'] = 1;
    $config['photo']['man_photo'][$nametype]['images_photo'] = true;
    $config['photo']['man_photo'][$nametype]['avatar_photo'] = true;
    $config['photo']['man_photo'][$nametype]['link_photo'] = true;
    ...
    $nametype = "slide-lien-he";
    $config['photo']['man_photo'][$nametype]['title_main_photo'] = "Slideshow liên hệ";
    $config['photo']['man_photo'][$nametype]['number_photo'] = 1;
    $config['photo']['man_photo'][$nametype]['images_photo'] = true;
    $config['photo']['man_photo'][$nametype]['avatar_photo'] = true;
    $config['photo']['man_photo'][$nametype]['link_photo'] = true;
  ...
  /* Đối tác */
    ...
    $config['photo']['man_photo'][$nametype]['avatar_photo'] = true;
    $config['photo']['man_photo'][$nametype]['link_photo'] = true;
    $config['photo']['man_photo'][$nametype]['width_photo'] = 170;
    $config['photo']['man_photo'][$nametype]['height_photo'] = 70;
    $config['photo']['man_photo'][$nametype]['thumb_photo'] = '170x70x1';
    $config['photo']['man_photo'][$nametype]['img_type_photo'] = '.jpg|.gif|.png|.jpeg|.gif|.JPG|.PNG|.JPEG|.Png|.GIF';
    ...
    $config['photo']['man_photo'][$nametype]['images_photo'] = true;
    $config['photo']['man_photo'][$nametype]['avatar_photo'] = true;
    $config['photo']['man_photo'][$nametype]['width_photo'] = 300;
    $config['photo']['man_photo'][$nametype]['height_photo'] = 180;
    $config['photo']['man_photo'][$nametype]['thumb_photo'] = '300x180x1';
    $config['photo']['man_photo'][$nametype]['img_type_photo'] = '.jpg|.gif|.png|.jpeg|.gif|.JPG|.PNG|.JPEG|.Png|.GIF';
